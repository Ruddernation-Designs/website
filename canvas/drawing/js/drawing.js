var _gaq = _gaq || [];
_gaq.push(["_setAccount", "UA-96550177-1"]);
...
Menu.prototype = {
    ...
    init: function() {
        ...
        this.about = document.createElement("Help");
        this.about.className = "button";
        this.about.innerHTML = "Help";
...
About.prototype = {
    ...
    init: function() {
        ...
        b.innerHTML = '<strong>Instructions</strong>';
        a.appendChild(b);
        b = document.createElement("p");
        b.style.textAlign = "center";
...
var SCREEN_WIDTH = window.innerWidth, SCREEN_HEIGHT = window.innerHeight, BRUSH_SIZE = 1, BRUSH_PRESSURE = 1, COLOR = [0, 0, 0], BACKGROUND_COLOR = [250, 250, 250], STORAGE = window.localStorage, brush, saveTimeOut, wacom, i, mouseX = 0, mouseY = 0, container, foregroundColorSelector, backgroundColorSelector, menu, about, canvas, flattenCanvas, context, isFgColorSelectorVisible = false, isBgColorSelectorVisible = false, isAboutVisible = false, isMenuMouseOver = false, shiftKeyIsDown = false, altKeyIsDown = false;
init();
function init() {
